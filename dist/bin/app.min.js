...
null===this.snapshot?void console.warn("Video.grab cannot run because Phaser.BitmapData is unavailable"):(t&&this.snapshot.cls(),this.snapshot.copy(this.video,0,0,this.width,this.height,0,0,this.width,this.height,0,0,0,1,1,e,i),this.snapshot)},removeVideoElement:function(){if(this.video){for(this.video.parentNode&&this.video.parentNode.removeChild(this.video);this.video.hasChildNodes();)this.video.removeChild(this.video.firstChild);this.video.removeAttribute("autoplay"),this.video.removeAttribute("src"),this.video=null}},destroy:function(){this.stop(),this.removeVideoElement(),this.touchLocked&&this.game.input.touch.removeTouchLockCallback(this.unlock,this),this._retryID&&window.clearTimeout(this._retryID)}},Object.defineProperty(i.Video.prototype,"currentTime",{get:function(){return this.video?this.video.currentTime:0},set:function(t){this.video.currentTime=t}}),Object.defineProperty(i.Video.prototype,"duration",{get:function(){return this.video?this.video.duration:0}}),Object.defineProperty(i.Video.prototype,"progress",{get:function(){return this.video?this.video.currentTime/this.video.duration:0}}),Object.defineProperty(i.Video.prototype,"mute",{get:function(){return this._muted},set:function(t){if(t=t||null){if(this._muted)return;this._codeMuted=!0,this.setMute()}else{if(!this._muted)return;this._codeMuted=!1,this.unsetMute()}}}),Object.defineProperty(i.Video.prototype,"paused",{get:function(){return this._paused},set:function(t){if(t=t||null,!this.touchLocked)if(t){if(this._paused)return;this._codePaused=!0,this.setPause()}else{if(!this._paused)return;this._codePaused=!1,this.setResume()}}}),Object.defineProperty(i.Video.prototype,"volume",{get:function(){return this.video?this.video.volume:1},set:function(t){0>t?t=0:t>1&&(t=1),this.video&&(this.video.volume=t)}}),Object.defineProperty(i.Video.prototype,"playbackRate",{get:function(){return this.video?this.video.playbackRate:1},set:function(t){this.video&&(this.video.playbackRate=t)}}),Object.defineProperty(i.Video.prototype,"loop",{get:function(){return this.video?this.video.loop:!1},set:function(t){t&&this.video?this.video.loop="loop":this.video&&(this.video.loop="")}}),Object.defineProperty(i.Video.prototype,"playing",{get:function(){return!(this.video.paused&&this.video.ended)}}),i.Video.prototype.constructor=i.Video,void 0===PIXI.blendModes&&(PIXI.blendModes=i.blendModes),void 0===PIXI.scaleModes&&(PIXI.scaleModes=i.scaleModes),void 0===PIXI.Texture.emptyTexture&&(PIXI.Texture.emptyTexture=new PIXI.Texture(new PIXI.BaseTexture)),void 0===PIXI.DisplayObject._tempMatrix&&(PIXI.DisplayObject._tempMatrix=new PIXI.Matrix),void 0===PIXI.RenderTexture.tempMatrix&&(PIXI.RenderTexture.tempMatrix=new PIXI.Matrix),PIXI.Graphics&&void 0===PIXI.Graphics.POLY&&(PIXI.Graphics.POLY=i.POLYGON,PIXI.Graphics.RECT=i.RECTANGLE,PIXI.Graphics.CIRC=i.CIRCLE,PIXI.Graphics.ELIP=i.ELLIPSE,PIXI.Graphics.RREC=i.ROUNDEDRECTANGLE),PIXI.TextureSilentFail=!0,"undefined"!=typeof exports?("undefined"!=typeof module&&module.exports&&(exports=module.exports=i),exports.Phaser=i):"undefined"!=typeof define&&define.amd?define("Phaser",function(){return e.Phaser=i}()):e.Phaser=i,i}.call(this),!function(t,e){"use strict";function i(s){this.__global__=s||t||e,this.__use__="localStorage",this.__class__=i,this._snapshots=[],this._validateInitialState(),this.has=function(t){return this._getNativeRoot()[t]?!0:!1},this.get=function(t,i){return t?this.has(t)?this._converter.decode(this._getNativeRoot()[t]):e:this.all()},this.all=function(t){var e=t?this._getNative():this._getNativeRoot(),i={_root:e,_store:this};for(var s in e)e.hasOwnProperty(s)&&(i[s]=this._converter.decode(e[s]));return i},this.set=function(t,e){if("object"!=typeof t)try{var i=this._getNativeRoot();i[t]=this._converter.encode(e)}catch(s){console.error('Couldn\'t set "%s" in %s: %s',"store."+t+" = "+typeof e,this.__use__,s.message)}else for(var n in t)this.set(n,t[n])},this.remove=function(t){if(this.has(t))try{delete this._getNative()[t]}catch(e){console.error("Couldn't delete %s: %s",t,e.message)}},this.flush=function(){try{this._getNative().clear()}catch(t){console.error("Couldn't clear %s: %s",this.__use__,t.message)}},this.each=function(t){var e=this._getNative();for(var i in e)e.hasOwnProperty(i)&&t(JSON.parse(e[i]),i,e)},this.use=function(t){this.__use__=t,this._validateStorage()},this.count=function(){return this.keys().length},this.keys=function(){return Object.keys(this._getNative())},this.serialize=function(){var t=this.all(),e=JSON.stringify(this._getNative());return this._saveSnapshot(t,e)}}i.prototype={_validateInitialState:function(){this._validateStorage()&&null===this._validateSelectedStorage()&&(this.__global__.Store=e)},_validateSelectedStorage:function(){return null===this._getNative()?(console.error("Storage type %s not avaible!",this.__use__),!1):!0},_validateStorage:function(){return typeof Storage===e?(console.warn("Storage is not supportet by your browser, please update"),this.__supported__=!1,!1):(this.__supported__=!0,!0)},_getNative:function(){var t=this.__global__[this.__use__];if(!t)throw new Error("No storage found to execute action!");return t},_getNativeRoot:function(){var t=this._getNative();return"string"==typeof this._namespace?JSON.parse(t[this._namespace]):t},_generateNamespace:function(t){return t=""+t,t=t.replace("-","_").replace(" ","_")},_converter:{decode:function(t){return JSON.parse(t)},encode:function(t){return JSON.stringify(t)}},_saveSnapshot:function(t,e){return this._snapshots.length>10&&this._snapshots.pop(),this._snapshots.push({origin:t,serialized:e,at:(new Date).toUTCString()}),this._snapshots[0]}},t.Store=new i(t)}(window),function(t,e){"use strict";var i=t.$,s=i||null;i={},i.giveBack=function(){return s},i.fadeOut=function(t,e){var i=1,s=setInterval(function(){.1>=i&&(clearInterval(s),t.style.display="none",(e||Util.noop)()),t.style.opacity=i,t.style.filter="alpha(opacity="+100*i+")",i-=.1*i},50)},i.fadeIn=function(t,e){var i=0,s=setInterval(function(){i>=1&&(clearInterval(s),t.style.display="block",(e||Util.noop)()),t.style.opacity=i,t.style.filter="alpha(opacity="+100*i+")",i+=.1*i},50)},i.requestFullscreen=function(t){t.requestFullscreen?t.requestFullscreen():t.msRequestFullscreen?t.msRequestFullscreen():t.mozRequestFullScreen?t.mozRequestFullScreen():t.webkitRequestFullscreen&&t.webkitRequestFullscreen()},t.$=i}(window),function(t,e){"use strict";t.Util={},t.Game={roundWinner:null},t.Container={World:{players:[]},Audio:{}},t.Factory={},t.Session={},t.$index={session:{}}}(window),function(t,e){"use strict";Container.settings={debug:!0,audio:{fx:["jump","die"]},render:{width:"100%",height:1e3,mode:Phaser.AUTO,node:"startgame"},physics:{mode:Phaser.Physics.ARCADE},game:{tilemap:"tilemap-space",doubleJump:!0,players:{offset:{x:110,y:500},baseName:"avatar-",basePath:"assets/img/avatars/",mimeType:"png",amount:3,variations:["techie","designer","consultant"],keymap:["up","down","left"],bounce:{y:.3},gravity:{y:900},velocity:{y:-600,x:250}}},worlds:{space:{contrast:"#ffffff",colors:["#50bcff","#a8c614","#ff5050"]}}}}(window);
!function(t,e){"use strict";function r(t){this.name="GameError",this.message=t||"Undefined error"}function o(t,e){return this.input=t,this.data=e,this}function i(e){this.enabled=t.Container.settings.debug===!0,this.namespace=e||"undefined"}r.prototype=Error.prototype,t.GameError=r,Util.noop=function(){},Util["default"]=function(t,r,o){return"function"==typeof o?o(t)===!0?t:r:t&&t!==e&&null!==t?t:r},Util.clone=function(t){if(!t||"object"!=typeof t)return t;var e=t.constructor();for(var r in t)t.hasOwnProperty(r)&&"_saveState"!==r&&(e[r]=t[r]);return e},Util.hyphenate=function(t){return t.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()},o.prototype={replace:function(t){var r=this.input;t===e&&(t=this.data);var o=Object.keys(t);return o.forEach(function(e){r=r.replace("{"+e+"}",t[e])}),r}},Util.replace=function(t,e){return new o(t).replace(e)},Util.Replacer=o,i.prototype={warn:function(){console&&console.warn&&this.$out(arguments,function(t){console.warn.apply(console,t)})},info:function(){console&&console.info&&this.$out(arguments,function(t){console.info.apply(console,t)})},error:function(){console&&console.error&&this.$out(arguments,function(t){console.error.apply(console,t)})},log:function(){console&&this.$out(arguments,function(t){console.log.apply(console,t)})},"throw":function(t,e){throw new r(t+"("+e+")")},$out:function(t,e){var r=Array.prototype.slice.call(t);r.unshift("["+this.namespace+"]:"),e(r)}},Util.Debugger=i,Util.calculate={score:function(t){var e=t/100;return Math.round(e)}}}(window),function(t,e){"use strict";function r(t,e,r,o,n){return this.$baseSprite=i.settings.game.players.baseName,this.$basePath=i.settings.game.players.basePath+i.settings.worldType+"/",this.$mimeType=i.settings.game.players.mimeType,this.id=e,this.type=n,this.jumpKey=i.settings.game.players.keymap[e],this.injector=t,this.doubleJump=!1,this.score=null,Phaser.Sprite.call(this,t,r,o,this.$getSpritesheet()),this.$addActionKey(),t.add.existing(this),this}var o=new Util.Debugger("Player.class"),i=t.Container;r.prototype=Object.create(Phaser.Sprite.prototype),r.prototype.constructor=r,r.prototype.init=function(){this.injector.physics.arcade.enable(this),this.body.bounce.y=i.settings.game.players.bounce.y,this.body.gravity.y=i.settings.game.players.gravity.y,this.body.collideWorldBounds=!0,this.body.linearDamping=1},r.prototype.collide=function(t,e){this.injector.game.arcade.collide(this,t,e,null)},r.prototype.run=function(){this.body.velocity.x=i.settings.game.players.velocity.x},r.prototype.jump=function(){this.body.onFloor()&&(Container.Audio.jump.play(),this.body.velocity.y=i.settings.game.players.velocity.y)},r.prototype.die=function(){o.info("Player died with id ->",this.id);var t=Session[$index.session[this.id]];o.info("Updating player session ->",t),Container.Audio.die.play(),t.text.option("extension","(dead)"),t.text.$update(),t.score=this.score,this.dead=!0,this.kill()},r.prototype.$addActionKey=function(){return o.info("Player created actionKey ->",this.jumpKey),this.$actionKey=Container.cursors[this.jumpKey]},r.prototype.$update=function(){this.score=Util.calculate.score(this.x),this.y===Container.settings.render.height-20&&this.die(),this.x<=Container.game.camera.view.x-70&&this.die(),this.$actionKey.isDown&&this.jump()},r.prototype.$getSpritesheet=function(){return this.type=this.type===e?"-"+i.settings.game.players.variations[this.id]:"",this.$baseSprite+i.settings.worldType+this.type},t.Factory.Player=r}(window),function(t,e){"use strict";function r(t,e,r){var o=i.settings.worldType;return this.template="{name}: {score} {extension}",this.injector=t,this.player=e,this.score=r||0,this.opts={extension:"",fontSize:"20px",fill:i.settings.worlds[o].contrast||"#ffffff"},this}var o=new Util.Debugger("ScoreText.class"),i=t.Container;r.prototype={get:function(){return Util.replace(this.template,{name:this.player,score:this.score,extension:this.opts.extension})},set:function(t){this.score=t,this.$update()},increase:function(t){this.score=this.score+t,this.$update()},option:function(t,e){this.opts[t]=e},add:function(t,e,r){i.settings.worldType;return t=t||0,e=e||0,this.$text=this.injector.add.text(t,e,this.get(),{font:this.opts.fontSize+" Roboto",fill:this.opts.fill}),this.$text.fixedToCamera=r||!1,r&&this.$text.cameraOffset.setTo(t,e),o.info("Text added with props x, y, fixed ->",t,e,r),this},$update:function(t){this.$text.setText(this.get())}},t.Factory.ScoreText=r}(window),function(t,e){"use strict";function r(t,e,r){return this.$id=n++,this.injector=t,this.image=e,this.path=r,this}var o=new Util.Debugger("Sprite.class"),i=(t.Container,t.Util),n=0;r.prototype=Object.create(Phaser.Sprite.prototype),r.prototype.constructor=r,r.prototype.load=function(t){return t=i["default"](t,this.path),this.injector.load.image(this.image,t),this},r.prototype.add=function(t,e){return o.info("Sprite mounted ->",this.image,t,e),t=i["default"](t,0),e=i["default"](e,0),this.injector.add.sprite(t,e,this.image),this},t.Factory.Sprite=r}(window),function(t,e){"use strict";function r(t,e){return this.name=e,this.injector=t,this.map=null,this.layers={},this}var o=new Util.Debugger("Tilemap.class");t.Container;r.prototype=Object.create(Phaser.Tilemap.prototype),r.prototype.constructor=r,r.prototype.addImage=function(t,e){return o.info("Tilemap image added with asset ->",t,e),this.map.addTilesetImage(t,e)},r.prototype.addToGame=function(t){return t=t||this.game||null,this.map=t.add.tilemap(this.name)},r.prototype.createLayer=function(t){o.info("Layer created ->",t);var e=this.map.createLayer(t);return this.layers[t]=e},r.prototype.setCollision=function(t,e,r){o.info("Collision set on layer with start/end ->",t,e,r);try{var i=this.map.setCollisionBetween(e,r,!0,t);return i}catch(n){throw new Error("Tilemap.setCollision faield: "+n.message)}},r.prototype.resize=function(t){try{this.layers[t].resizeWorld(),o.warn("World resized to the layer ->",t)}catch(e){o["throw"]("Tilemap.resize failed: "+e.message,0)}},t.Factory.Tilemap=r}(window),function(t,e){"use strict";Container.Boot=function(t){},Container.Boot.prototype={preload:function(){this.$loadWorldDependencies(),this.$loadAudioFX()},create:function(){this.state.start("Preload")},$loadWorldDependencies:function(){var t=this,e=Object.keys(Container.settings.worlds);e.forEach(function(e){t.load.tilemap("tilemap-"+e,"assets/img/world/"+e+"/tilemap-"+e+".json",null,Phaser.Tilemap.TILED_JSON),t.load.image("background-"+e,"assets/img/backgrounds/background-"+e+".png"),t.load.image("tile-"+e,"assets/img/world/"+e+"/tiles/tile-"+e+".png"),t.load.image("avatar-"+e+"-consultant","assets/img/avatars/"+e+"/avatar-"+e+"-consultant.png"),t.load.image("avatar-"+e+"-techie","assets/img/avatars/"+e+"/avatar-"+e+"-techie.png"),t.load.image("avatar-"+e+"-designer","assets/img/avatars/"+e+"/avatar-"+e+"-designer.png")})},$loadAudioFX:function(){var t=this,e=Container.settings.audio.fx;e.forEach(function(e){t.load.audio("fx-"+e,"assets/audio/fx/"+e+".mp3")})}}}(window),function(t,e){"use strict";var r=new Util.Debugger("states.game"),o=Container.settings.game;Container.Game=function(t){},Container.Game.prototype={create:function(){var t=this;this.$createAudioFX(),this.$createBackground(),this.$createTilemap(),Container.cursors=this.input.keyboard.createCursorKeys(),this.$createScoreTexts(),this.$createPlayers(function(){t.camera.follow(t.$furthestPlayer().player)})},update:function(){var t=this,e=t.$getAlivePlayers();t.camera.follow(t.$furthestPlayer().player),0===e.length?t.exit():1===e.length;for(var r in Session){var o=Session[r].player();Container.game.physics.arcade.collide(o,Container.World.tilemapLayer),Session[r].text.set(Util.calculate.score(o.x)),o.dead!==!0&&(o.$update(),o.run())}},exit:function(){var e=this;this.finished=!0,e.$savePlayerScores(),r.info("Game is finished! Player scores are saved in Storage"),$.fadeOut(document.getElementById(Container.settings.render.node),function(){Container.game.lockRender=!0,t.location.href="scores.html"})},$getAlivePlayers:function(){var t=[];return Container.World.players.forEach(function(e){e.alive===!0&&t.push(e)}),t},$furthestPlayer:function(){var t=Container.World.players[0],e=Container.World.players[0].x;return Container.World.players.forEach(function(r){r.x>e&&(e=r.x,t=r)}),{player:t,position:e}},$createAudioFX:function(){var t=this,e=Container.settings.audio.fx;e.forEach(function(e){Container.Audio[e]={node:t.add.audio("fx-"+e),play:function(){Container.Audio[e].node.restart()}}})},$createPlayerSession:function(t,e,r){var o=Container.settings.worlds,i=Container.settings.worldType;return $index.session[r]=t,Session[t]={id:r,name:e,username:t,color:o[i].colors[r],player:function(){return Container.World.players[r]}}},$createScoreTexts:function(){var t=this,e=0,r=Container.settings.currentPlayers;r.forEach(function(r){r=r.trim();var o=r.replace(" ","");t.$createPlayerSession(o,r,e);var i=new Factory.ScoreText(t,o.toUpperCase(),0);i.option("fill",Session[o].color),i.add(20,22*(e+1),!0),Session[o].text=i,e++})},$createBackground:function(){var t=new Factory.Sprite(this,"background-"+Container.settings.worldType);t.add(0,0)},$createTilemap:function(){var t=this,e=Container.settings.worldType,r=new Factory.Tilemap(t,"tilemap-"+e);r.addToGame(t),r.addImage("tile-"+e,"tile-"+e);var o=r.createLayer("world");r.setCollision("world",0,5e3),r.resize("world"),Container.World.tilemapLayer=o},$createPlayers:function(t){for(var e=this,r=o.players.offset,i=0;i<o.players.amount;i++){var n=new Factory.Player(e,i,r.x*i,r.y);n.init(),Container.World.players.push(n)}return t(Container.World.players)},$savePlayerScores:function(){for(var t in Session){var e=Session[t];Container.Store.score(e.name,e.score,Container.settings.worldType)}}}}(window),function(t,e){"use strict";Container.game;Container.Preload=function(t){this.ready=!1,this.error=null,this.background=null},Container.Preload.prototype={preload:function(){try{this.physics.startSystem(Phaser.Physics.ARCADE),this.ready=!0}catch(t){this.error=t}},create:function(){if(!this.ready)throw this.error;this.state.start("Game")},quit:function(t){alert("Goodbye"),this.ready=!1}}}(window),function(t,e){"use strict";var r=(Container.game,t.Store),o=function(t){};o.prototype={score:function(t,e,o){r.has("score")&&Array.isArray(r.get("score"))||this.resetScore();var i=r.get("score");i.push({holder:t,score:e,map:o}),r.set("score",i)},getHighscore:function(t){var e=this.$getScore()[0];return t?e:e.score},resetScore:function(){r.set("score",[])},$orderScore:function(t){function e(t,e){return t.score>e.score?-1:t.score<e.score?1:0}return t.sort(e)},$getScore:function(){return this.$orderScore(r.get("score"))}},Container.Store=new o}(window),function(t,e){"use strict";var r=t.$,o=Container.settings.render,i=document.getElementById("js-start-game");return i?void i.addEventListener("click",function(){r.fadeOut(document.getElementById("js-hide-start")),Container.settings.worldType=document.getElementById("js-world").value,Container.settings.currentPlayers=document.getElementById("js-player-list").value.split(","),Container.settings.game.players.amount=Container.settings.currentPlayers.length;var t=new Phaser.Game(o.width,o.height,o.mode,o.node);t.state.add("Boot",Container.Boot),t.state.add("Preload",Container.Preload),t.state.add("Game",Container.Game),t.state.add("Procedures",Container.Procedures),t.state.start("Boot"),Container.game=t}):!1}(window);